...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        ...
        <p class="text-muted">Laporan performa kehadiran dan kalkulasi potongan gaji.</p>
    </div>
...
<div class="card border-0 shadow-sm mb-4" style="border-radius: 20px;">
    <div class="card-body p-4">
        <form action="{{ route('admin.absensi') }}" method="GET" class="row g-3 align-items-end">
            <div class="col-md-4">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <span class="badge rounded-pill bg-primary-soft text-primary px-3">{{ $r->periode }}</span>
                    </td>
                    <td class="text-center fw-bold">{{ $r->hadir }} <small class="text-muted">Hari</small></td>
